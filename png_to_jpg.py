...
dataset_dir = f"/home/wangdongzhihan/datasets/KiC4R/dataset/sequences/"
new_root_dir = f"/home/wangdongzhihan/datasets/KiC4R/dataset/sequences_jpg/"
...
for seq_nb in range(4): # list all sequences ["00", ... "21"]
    ...
    images_list = glob(os.path.join(dataset_dir, seq, "image_{}".format(image_nb), "data", "*"))  # paths to png images in seq
