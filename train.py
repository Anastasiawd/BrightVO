...
if __name__ == "__main__":
    ...
    args = {
        "data_dir": "data",
        "bsize": 1,  # batch size
        "val_split": 0.2,  # percentage to use as validation data
        ...
        "checkpoint_path": "checkpoints/Exp7",  # path to save checkpoint
    ...
    # train_data =Subset(dataset, range(nb_train))
    # val_data = torch.utils.data.Subset(dataset, range(nb_train, len(dataset)))
